...
from .wan_transformer3d import WanTransformer3DModelGeoWorldstage1, WanTransformer3DModelGeoWorldstage2
...
if importlib.util.find_spec("pai_fuser") is not None:
    ...
    WanTransformer3DModelGeoWorldstage1.enable_cfg_skip = enable_cfg_skip()(WanTransformer3DModelGeoWorldstage1.enable_cfg_skip)
    WanTransformer3DModelGeoWorldstage1.disable_cfg_skip = disable_cfg_skip()(WanTransformer3DModelGeoWorldstage1.disable_cfg_skip)

    WanTransformer3DModelGeoWorldstage2.enable_cfg_skip = enable_cfg_skip()(WanTransformer3DModelGeoWorldstage2.enable_cfg_skip)
    WanTransformer3DModelGeoWorldstage2.disable_cfg_skip = disable_cfg_skip()(WanTransformer3DModelGeoWorldstage2.disable_cfg_skip)
