...
class WanFunControlPipelineGeoWorldstage1(DiffusionPipeline):
    r"""
    ...
    def __call__(
        ...
        if clip_image is not None:
            ...
            vggt_feature, _ = self.vggt.aggregator(img_tensor.to(device, weight_dtype).unsqueeze(0).unsqueeze(0))
