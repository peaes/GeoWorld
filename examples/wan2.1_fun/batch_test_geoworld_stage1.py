...
base_save_path = "test_geoworld_stage1"
base_stage1_path = "testset_dir"
...
from videox_fun.models import (AutoencoderKLWan, AutoTokenizer, CLIPModel,
                               WanT5EncoderModel)
from videox_fun.models import WanTransformer3DModelGeoWorldstage1 as WanTransformer3DModel
from videox_fun.data.dataset_image_video import process_pose_file
from videox_fun.models.cache_utils import get_teacache_coefficients
from videox_fun.pipeline import WanFunControlPipelineGeoWorldstage1 as WanFunControlPipeline
...
def process_folder(folder_path, output_dir, stage1_dir):
    """处理单个测试文件夹"""
    mp4_path = os.path.join(stage1_dir, "1.mp4")
